...
class Test_AddOneMap:
    ...
    def test_map_function_increments_value(self):
        ...
        # Act
        result = self.add_one_map.map(test_integer)

        # Assert
        assert result == 6, "Check map increments by one - failed"
    ...
    def test_map_function_with_negative_numbers(self):
        ...
        # Assert
        assert result == -4, "Test with negative numbers - failed"

    @pytest.mark.performance
    def test_map_function_with_large_numbers(self):
        # Arrange
        test_integer = 10**18   # Change this value as per the 'int' range in Python

        # Act
        result = self.add_one_map.map(test_integer)

        #Assert
        assert result == (10**18 + 1), "Test with large numbers - failed"
    ...
    def test_map_function_with_zero(self):
        ...
        # Assert
        assert result == 1, "Map function with zero input - failed"
